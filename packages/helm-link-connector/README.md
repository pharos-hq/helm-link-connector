...
code, or paste or screenshot the command. Version `0.1.7` is eligible for
...
```bash
npx --yes '@pharos-hq/helm-link-connector@0.1.7' install-service
npx --yes '@pharos-hq/helm-link-connector@0.1.7' service-status
```
