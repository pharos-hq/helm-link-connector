...
code, or paste or screenshot the command. Version `0.2.1` is the current
...
The `0.2.1` archive is prepared but the tag-bound publish workflow remains
...
```bash
npx --yes '@pharos-hq/helm-link-connector@0.2.1' install-service
npx --yes '@pharos-hq/helm-link-connector@0.2.1' service-status
npx --yes '@pharos-hq/helm-link-connector@0.2.1' uninstall-service
```
