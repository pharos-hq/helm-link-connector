...
code, or paste or screenshot the command. Version `0.1.6` is eligible for
...
```bash
npx --yes '@pharos-hq/helm-link-connector@0.1.6' doctor --agent your-openclaw-agent-id
```
...
```bash
npx --yes '@pharos-hq/helm-link-connector@0.1.6' install-service
npx --yes '@pharos-hq/helm-link-connector@0.1.6' service-status
```
