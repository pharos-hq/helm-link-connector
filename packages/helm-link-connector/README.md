...
code, or paste or screenshot the command. Version `0.1.8` is eligible for
...
```bash
npx --yes '@pharos-hq/helm-link-connector@0.1.8' doctor --agent your-openclaw-agent-id
```
...
```bash
npx --yes '@pharos-hq/helm-link-connector@0.1.8' install-service
npx --yes '@pharos-hq/helm-link-connector@0.1.8' service-status
```
