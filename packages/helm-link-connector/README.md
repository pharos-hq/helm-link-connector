...
code, or paste or screenshot the command. Version `0.2.6` is the current
...
The `0.2.6` archive is prepared but the tag-bound publish workflow remains
...
```bash
npx --yes '@pharos-hq/helm-link-connector@0.2.6' doctor --agent your-openclaw-agent-id
```
...
```bash
npx --yes '@pharos-hq/helm-link-connector@0.2.6' install-service
npx --yes '@pharos-hq/helm-link-connector@0.2.6' service-status
npx --yes '@pharos-hq/helm-link-connector@0.2.6' uninstall-service
```
