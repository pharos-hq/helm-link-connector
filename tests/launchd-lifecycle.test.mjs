...
assert.equal(second.version, '0.2.8')
assert.equal(existsSync(join(stateDir, 'runtime', '0.2.8', 'bin', 'helm-link.mjs')), true)
assert.equal(existsSync(join(stateDir, 'runtime', '0.2.8', 'lib', 'lifecycle-journal.mjs')), true)
...
rmSync(join(stateDir, 'runtime', '0.2.8', 'lib', 'lifecycle-journal.mjs'))
...
assert.equal(liveStatus.connectorVersion, '0.2.8')
